...
$result = query("SELECT * FROM panorama ORDER BY Expiration asc" );
...
if( isset($_POST['cari']) ) {
  ...
  if( $_POST['katakunci'] == '') {
    $result = query("SELECT * FROM panorama");
  } else {
...
<h3><i class="fa fa-angle-right"></i> License Panorama</h3>
<div class="row mb">
    <!-- page start-->
                        ...
                        <td>
                            <center>
                                <a class="btn btn-outline-success btn-sm"
                                    href="index.php?page=detailpanorama&id=<?= $data['id']; ?>">DETAIL | </a>
                                <a class="btn btn-outline-warning btn-sm"
                                    href="index.php?page=editpanorama&id=<?= $data['id']; ?>">EDIT | </a>
                                <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                    href="index.php?page=deletepanorama&id=<?= $data['id']; ?>">HAPUS</a>
                            </center>
                        </td>
                        <?php $x++; ?>
                        <?php endforeach; ?>
