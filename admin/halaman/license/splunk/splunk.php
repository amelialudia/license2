...
$result = query("SELECT * FROM splunk ORDER BY expiration asc" );
...
if( isset($_POST['cari']) ) {
  ...
  if( $_POST['katakunci'] == '') {
    $result = query("SELECT * FROM splunk");
  } else {
...
<h3><i class="fa fa-angle-right"></i> License splunk</h3>
<div class="row mb">
    <!-- page start-->
    <div class="content-panel">
        <form action="" method="POST" class="pull-right position search_inbox">
            ...
            <div><a href="index.php?page=exportsplunk">
                <button class="btn btn-primary" id="cetak"> Cetak Data </button></a></div> <br>
            </div>
</form>
        <br><br>
        <div><a href="index.php?page=tambahsplunk">
                        ...
                        <td>
                            <center>
                                <a class="btn btn-outline-success btn-sm"
                                    href="index.php?page=detailsplunk&id=<?= $data['id']; ?>">DETAIL | </a>
                                <a class="btn btn-outline-warning btn-sm"
                                    href="index.php?page=editsplunk&id=<?= $data['id']; ?>">EDIT | </a>
                                <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                    href="index.php?page=deletesplunk&id=<?= $data['id']; ?>">HAPUS</a>
                            </center>
                        </td>
                        <?php $x++; ?>
                        <?php endforeach; ?>
