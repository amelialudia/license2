...
<h3><i class="fa fa-angle-right"></i> ATS</h3>
<div class="row mb">
    <!-- page start-->
                ...
                <tbody>
                    ...
                    <?php foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-outline-success btn-sm" href="index.php?page=detailatsa&id=<?= $data['id']; ?>">DETAIL | </a>
                                    <a class="btn btn-outline-warning btn-sm" href="index.php?page=editatsa&id=<?= $data['id']; ?>">EDIT | </a>
