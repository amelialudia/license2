      ...
      <section class="wrapper">
        ...
        if (isset($_GET['page'])) {
          ...
          switch ($page) {
            ...
            case 'shield':
              include "halaman/product/code/shield/shield.php";
              break;
            case 'detailshield':
              include "halaman/product/code/shield/detail.php";
              break;
            case 'editshield':
              include "halaman/product/code/shield/edit.php";
              break;
            case 'deleteshield':
              include "halaman/product/code/shield/delete.php";
              break;
              case 'tambahshield':
                include "halaman/product/code/shield/tambah.php";
                break;

            case 'qr':
              include "halaman/product/code/qr/qr.php";
              break;
            case 'detailqr':
              include "halaman/product/code/qr/detail.php";
              break;
            case 'editqr':
              include "halaman/product/code/qr/edit.php";
              break;
            case 'deleteqr':
              include "halaman/product/code/qr/delete.php";
              break;
              case 'tambahqr':
                include "halaman/product/code/qr/tambah.php";
                break;

            case 'keyla':
              include "halaman/product/code/keyla/keyla.php";
              break;
            case 'detailkeyla':
              include "halaman/product/code/keyla/detail.php";
              break;
            case 'editkeyla':
              include "halaman/product/code/keyla/edit.php";
              break;
            case 'deletekeyla':
              include "halaman/product/code/keyla/delete.php";
              break;
              case 'tambahkeyla':
                include "halaman/product/code/keyla/tambah.php";
                break;

            case 'exporteartag':
              include "halaman/product/code/eartag/export.php";
              break;
            case 'eartag':
              include "halaman/product/code/eartag/eartag.php";
              break;
            case 'detaileartag':
              include "halaman/product/code/eartag/detail.php";
              break;
            case 'editeartag':
              include "halaman/product/code/eartag/edit.php";
              break;
            case 'deleteeartag':
              include "halaman/product/code/eartag/delete.php";
              break;
            case 'tambaheartag':
              include "halaman/product/code/eartag/tambah.php";
              break;
            ...
            case 'tambahatsb':
              ...
              break;
            case 'deleteatsb':
              include "halaman/ats/atsb/delete.php";
              break;
            case 'editatsb':
            ...
            case 'tambahatsa':
              ...
              break;
            case 'deleteatsa':
              include "halaman/ats/atsa/delete.php";
              break;
            case 'editatsa':
              include "halaman/ats/atsa/edit.php";
              break;
            case 'exportatsa':
              include "halaman/ats/atsa/cetak.php";
              break;
            ...
            case 'tambahsplunk':
              ...
              break;
            case 'deletesplunk':
              include "halaman/license/splunk/delete.php";
              break;
            case 'editsplunk':
            ...
            case 'tambahsolarwind':
              ...
              break;
            case 'deletesolarwind':
              include "halaman/license/solarwind/delete.php";
              break;
            case 'editsolarwind':
            ...
            case 'tambahpanorama':
              ...
              break;
            case 'deletepanorama':
              include "halaman/license/panorama/delete.php";
              break;
            case 'editpanorama':
            ...
            case 'tambahpaloalto':
              ...
              break;
            case 'deletepaloalto':
              include "halaman/license/paloalto/delete.php";
              break;
            case 'editpaloalto':
            ...
            case 'tambahfortigate':
              ...
              break;
            case 'deletefortigate':
              include "halaman/license/fortigate/delete.php";
              break;
            case 'editfortigate':
            ...
            case 'tambahfortianalyzer':
              ...
              break;
            case 'deletefortianalyzer':
              include "halaman/license/fortianalyzer/delete.php";
              break;
            ...
            case 'tambahredhat':
              ...
              break;
            case 'deleteredhat':
              include "halaman/license/redhat/delete.php";
              break;
            case 'editredhat':
            ...
            case 'tambahngtm01':
              ...
              break;
            case 'deletengtm01':
              include "halaman/license/ngtm01/delete.php";
              break;
            case 'editngtm01':
            ...
            case 'tambahvmware':
              ...
              break;
            case 'deletevmware':
              include "halaman/license/vmware/delete.php";
              break;
            case 'editvmware':
