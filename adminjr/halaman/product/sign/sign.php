...
$result = query("SELECT * FROM sign ORDER BY end_date ASC");
...
<h3><i class="fa fa-angle-right"></i> Peruri SIGN</h3>
<div class="row mb">
    <!-- page start-->
    <div class="content-panel">
        <form action="" method="POST" class="pull-right position search_inbox">
            ...
            <div><a href="index.php?page=cetaksign">
                <button class="btn btn-primary" id="cetak"> Cetak Data </button></a></div> <br>
            </div>
        </form>
        <br><br>
        <div><a href="index.php?page=tambahsign">
                ...
                <tbody>
                    ...
                    <?php foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-outline-success btn-sm" href="index.php?page=detailsign&id=<?= $data['id']; ?>">DETAIL</a>
