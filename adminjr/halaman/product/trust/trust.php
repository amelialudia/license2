...
$result = query("SELECT * FROM trust ORDER BY end_date ASC");
...
if (isset($_POST['cari'])) {
    ...
    if ($_POST['katakunci'] == '') {
        $result = query("SELECT * FROM trust");
    } else {
...
<h3><i class="fa fa-angle-right"></i> Peruri Trust</h3>
<div class="row mb">
    <!-- page start-->
    <div class="content-panel">
        <form action="" method="POST" class="pull-right position search_inbox">
            ...
            <div><a href="index.php?page=cetaktrust">
                <button class="btn btn-primary" id="cetak"> Cetak Data </button></a></div> <br>
            </div>
        </form>
        <br><br>
        <div><a href="index.php?page=tambahtrust">
                ...
                <tbody>
                    ...
                    <?php foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-outline-success btn-sm" href="index.php?page=detailtrust&id=<?= $data['id']; ?>">DETAIL </a>
