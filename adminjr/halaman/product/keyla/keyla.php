...
$result = query("SELECT * FROM keyla ORDER BY end_date ASC");
...
if (isset($_POST['cari'])) {
    ...
    if ($_POST['katakunci'] == '') {
        $result = query("SELECT * FROM keyla");
    } else {
...
<h3><i class="fa fa-angle-right"></i> Peruri Keyla</h3>
<div class="row mb">
    <!-- page start-->
    <div class="content-panel">
        <form action="" method="POST" class="pull-right position search_inbox">
            ...
            <div><a href="index.php?page=cetakkeyla">
                <button class="btn btn-primary" id="cetak"> Cetak Data </button></a></div> <br>
            </div>
        </form>
        <br><br>
        <div><a href="index.php?page=tambahkeyla">
                ...
                <tbody>
                    ...
                    <?php foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-outline-success btn-sm" href="index.php?page=detailkeyla&id=<?= $data['id']; ?>">DETAIL</a>
